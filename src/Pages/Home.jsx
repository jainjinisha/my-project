...
const Home = () => {
  return (
    <div
      className="min-h-screen w-full bg-contain bg-top width: [1800px] height: [2592px] angle: 0 deg opacity: 1;"
    ...
    >
      ...
      <div className="flex flex-row gap-64">
        <div className="items-center justify-between text-white">
          ...
          />
          <Buttons btn1="Buy Now" btn2="Live Demo ..." />
        </div>

        <div className="z-20  mt-[130px] mr-4">
          <div className="font-inter w-[400px] h-[500px] rounded-[77px] border-2 border-white/20 backdrop-blur-[8px] border-gradient-to-r from white/20 via black/0 to-white/20 shadow-[0_9px_18px_rgba(0,0,0,0.25)] flex flex-col p-8">
            <img
              src={require("../Images/AglaonemaPlant.png")}
              alt="Aglaonema Plant"
              className="w-[459px] h-[459px] mt-[-120px] mt-4"
            />
            <div className="flex flex-row pl-8 items-center justify-between">
              <div>
                <p className="text-xl text-white">Indoor Plant</p>
